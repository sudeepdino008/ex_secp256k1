defmodule ExSecp256k1 do
  ...
  use RustlerPrecompiled,
    otp_app: :ex_secp256k1_rpe,
    crate: :exsecp256k1,
    base_url: "https://github.com/sudeepdino008/ex_secp256k1/releases/download/v#{version}",
    force_build: System.get_env("EXSECP_BUILD") in ["1", true] or env_config[:ex_secp256k1_rpe],
    targets:
